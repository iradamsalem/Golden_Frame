...
const styles = StyleSheet.create({
  ...
  rankBadge: { position: 'absolute', top: 10, left: 10, backgroundColor: '#E2B64D', width: 30, height: 30, borderRadius: 15, justifyContent: 'center', alignItems: 'center', zIndex: 1 },
  ...
  button: { backgroundColor: '#E2B64D', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 25, justifyContent: 'center', alignItems: 'center', height: 50, minWidth: 250 },
