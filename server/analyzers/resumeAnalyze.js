export const analyzeResumePhoto = (photoScoresMap) => {
  const weights = {
    resolution: 0.25,   
    variance: 0.20,       
    face: 0.15,          
  ...
  const preferredRGB = [
    ...
    { red: 173, green: 216, blue: 230 },   // #ADD8E6
    { red: 128, green: 128, blue: 128 },   // #808080
    { red: 255, green: 255, blue: 255 },   // #FFFFFF
    { red: 245, green: 245, blue: 220 },   // #F5F5DC
    { red: 128, green: 128, blue: 0 }      // #808000
  ];
  ...
  const avoidRGB = [
    ...
    { red: 255, green: 69, blue: 0 },      // #FF4500
    { red: 139, green: 0, blue: 0 }        // #8B0000
  ];
